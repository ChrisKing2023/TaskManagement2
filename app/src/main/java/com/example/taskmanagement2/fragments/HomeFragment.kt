package com.example.taskmanagement2.fragments
...
import com.example.taskmanagement2.MainActivity
import com.example.taskmanagement2.R
import com.example.taskmanagement2.adapter.TaskAdapter
import com.example.taskmanagement2.databinding.FragmentHomeBinding
...
class HomeFragment : Fragment(R.layout.fragment_home), SearchView.OnQueryTextListener, MenuProvider {
    ...
    private fun searchTask(query: String?){
        ...
        taskViewModel.searchNote(searchQuery).observe(this){ list ->
