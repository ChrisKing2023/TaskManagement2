...
import com.example.taskmanagement2.databinding.FragmentAddTaskBinding
...
class AddTaskFragment : Fragment(R.layout.fragment_add_task), MenuProvider {
    ...
    private fun saveTask(view: View){
        ...
        if(taskTitle.isNotEmpty()){
            ...
            Toast.makeText(addTaskView.context, "Please enter the Task Title", Toast.LENGTH_SHORT).show()
        }
    }
